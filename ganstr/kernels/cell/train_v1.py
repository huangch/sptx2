    ...
    for epoch in optimizationRange:
        ...
        for i, (imgs, uuid, trns, sbtps) in enumerate(trainingDataLoader):
            ...
            if opt.tensorboard:
                ...
                #         if 'disc_loss' in tag \
                #         or 'adv_loss' in tag \
                #         or 'recon_loss' in tag \
                #         or 'cell_corr_loss' in tag \
                #         or 'gene_corr_loss' in tag \
                #         or 'cls_loss' in tag \
                #         or 'disc_acc' in tag \
                #         or 'cls_acc' in tag \
                #         or 'cell_corr' in tag \
                ...
                #         or 'gene_corr' in tag \
                #         or 'gene_pval' in tag \
                #         or ( opt.model == 'vae' and 'kl_loss' in tag) \
                #         or ((opt.model == 'vqvae' or opt.model == 'resvqvae') and 'vq_loss' in tag):
