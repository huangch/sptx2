...
#             nn.ReLU(True),
#             nn.Linear(in_channels, num_residual_hiddens, bias=False),
#             nn.ReLU(True),
#             nn.Linear(num_residual_hiddens, num_hiddens, bias=False)
#         )
#
#     def forward(self, x):
...
class Generator(nn.Module):
    def __init__(self, gene_num, latent_dim, num_embeddings = 1024, commitment_cost = 0.25, decay = 0.99):
        ...
        #     nn.BatchNorm1d(3*3*latent_dim),
        #     nn.Linear(3*3*latent_dim, 1024),
        #     ResidualStack1d(in_channels=1024,
        #                   num_hiddens=1024,
